...
![figmatable](src/image.png/figmatable.png)



![figmatable](src/image.png/fifmachart.png)
...
- **src/**:Contains all React components, styles, and utility and calc functions.
 ...
 **Alpha Vantage API URL Construction**
 ...
 ```js
 const stockUrl = (symbol) => `https://www.alphavantage.co/query?function=TIME_SERIES_MONTHLY_ADJUSTED&
...
>>Annual Returns: It computes the overall return for each year by compounding the monthly returns.<br/>
...
![MSFTtable](src/image.png/MSFTtable.png)

![IBMtable](src/image.png/IBMtable.png)



![TSCOtable](src/image.png/TSCOtable.png)
...
- **```calculateStockDataForTable```:**

 A utility function to process and format the stock data for display in the table.
